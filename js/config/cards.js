...
const CARD_CONFIG = {
    ...
    worlds: [
        {
            ...
            sets: [
                ...
                { ids: ['ssr_001', 'ssr_002'], name: '神王套装', bonus: { power: 100, points: 30 } },
            ]
        }
        // 世界2、世界3... 后续由用户填充
    ],
    ...
    pool: [
        ...
        { id: 'n_003', name: '铜币袋', rarity: 'N', basePower: 2, effect: 'gold', desc: '系统点产出 +2' },
        ...
        { id: 'r_003', name: '幸运金币', rarity: 'R', basePower: 5, effect: 'gold', desc: '系统点产出 +5，抽卡券产出 +1' },
        ...
        { id: 'sr_003', name: '聚宝盆', rarity: 'SR', basePower: 15, effect: 'gold', desc: '系统点产出 +15，每10关额外获得抽卡券' },
        { id: 'sr_004', name: '时空沙漏', rarity: 'SR', basePower: 12, effect: 'utility', desc: '离线收益+50%，在线时每分钟额外+1系统点' },
        ...
        { id: 'ssr_002', name: '永恒王冠', rarity: 'SSR', basePower: 50, effect: 'gold', desc: '系统点产出 +50，成就奖励+30%' },
